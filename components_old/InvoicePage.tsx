...
type InvoicePageProps = {
  ...
  invoiceWeeklySummary: any;
  formatCurrency: (value: any) => string;
  invoiceSpendForm: any;
  setInvoiceSpendForm: (form: any) => void;
  handleSaveInvoiceSpend: () => void;
  handleSidebarNavigation: (viewKey: string) => void;
  invoiceSpendMessage: string;
  sortedInvoiceSpendRecords: any[];
  getInvoiceRecordSupplierName: (record: any) => string;
  getInvoiceRecordDateValue: (record: any) => string;
  getInvoiceRecordTotal: (record: any) => number;
  getMondayWeekStart: (dateInput: any) => string;
  deleteInvoiceSpendRecord: (id: string) => void;
};
